        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_MembershipPlan_Price", "[MonthlyPrice] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    District = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: true),
                    IsAcceptingClients = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerProfiles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrainerProfiles_Users_ReviewedByUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Membership_Sessions", "[SessionsRemaining] >= 0");
                    table.CheckConstraint("CK_Membership_Window", "[EndsAtUtc] > [StartsAtUtc]");
                    table.ForeignKey(
                        name: "FK_Memberships_ClientProfiles_ClientProfileId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Availability_Window", "[EndsAtUtc] > [StartsAtUtc]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ViewedTrainerProfileId = table.Column<int>(type: "int", nullable: true),
                    CityId = table.Column<int>(type: "int", nullable: true),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SearchHistory_Categories_CategoryId",
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_SearchHistory_Specialities_SpecialityId",
                        column: x => x.SpecialityId,
                        principalTable: "Specialities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.SetNull);
                    table.ForeignKey(
                        name: "FK_SearchHistory_TrainerProfiles_ViewedTrainerProfileId",
                        column: x => x.ViewedTrainerProfileId,
                        principalTable: "TrainerProfiles",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Services_TrainerProfiles_TrainerProfileId",
                        column: x => x.TrainerProfileId,
                        principalTable: "TrainerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerDocuments", x => x.Id);
                    table.ForeignKey(
                        name: "FK_TrainerDocuments_TrainerProfiles_TrainerProfileId",
                        column: x => x.TrainerProfileId,
                        principalTable: "TrainerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TrainerSpecialities", x => new { x.TrainerProfileId, x.SpecialityId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TrainerSpecialities_TrainerProfiles_TrainerProfileId",
                        column: x => x.TrainerProfileId,
                        principalTable: "TrainerProfiles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Booking_Window", "[EndsAtUtc] > [StartsAtUtc]");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Payment_Target", "([BookingId] IS NOT NULL AND [MembershipId] IS NULL) OR ([BookingId] IS NULL AND [MembershipId] IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Availabilities_TrainerProfileId_StartsAtUtc",
                table: "Availabilities",
                columns: new[] { "TrainerProfileId", "StartsAtUtc" },
                unique: true);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Bookings_TrainerProfileId_StartsAtUtc",
                table: "Bookings",
                columns: new[] { "TrainerProfileId", "StartsAtUtc" },
                unique: true,
                filter: "[Status] < 4");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Memberships_ClientProfileId_Status",
                table: "Memberships",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SearchHistory_CategoryId",
                table: "SearchHistory",
                column: "CategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SearchHistory_SpecialityId",
                table: "SearchHistory",
                column: "SpecialityId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SearchHistory_ViewedTrainerProfileId",
                table: "SearchHistory",
                column: "ViewedTrainerProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Services_TrainerProfileId",
                table: "Services",
                column: "TrainerProfileId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerDocuments_TrainerProfileId",
                table: "TrainerDocuments",
                column: "TrainerProfileId");

            migrationBuilder.CreateIndex(
                name: "IX_TrainerProfiles_ReviewedByUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_TrainerProfiles_VerificationStatus",
                table: "TrainerProfiles",
